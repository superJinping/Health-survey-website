    ...
    <el-row type="flex" justify="center" align="middle" class="header-row">
        <el-col :span="21">
            <el-menu mode="horizontal" :default-active="$route.path" router>
                <el-menu-item class="el-menu-item" index="/collection">My questionnaire</el-menu-item>
                <el-menu-item class="el-menu-item" index="/create" @click="gotoCreate">Create questionnaire</el-menu-item>
                <el-menu-item class="el-menu-item" index="/help">Help Centre</el-menu-item>
            </el-menu>
        </el-col>
        <el-col :span="3">
            <el-avatar v-if="!this.$store.state.login" @click.native="gotoLogin" style="cursor: pointer">sign in</el-avatar>
