    ...
    <div>
        ...
        <el-dialog :title="title" :visible.sync="dialogOutlineDataVisible">
            ...
            <div class="description-box">
                <div>
                    <b>Questionnaire Description:</b>{{description}}
                </div>
                <div>
                    <b>questionnaire status:</b>{{translateLabel[status]}}
                </div>
                <div>
                    <b>Fill in the numbers:</b>{{fillCount}}
                </div>
                <div>
                    <b>Release time:</b>{{createTime}}
                </div>
                <div>
                    <b>cut-off time:</b>{{endTime}}
                </div>
            </div>
            ...
            <el-button v-if="status==='collecting'" @click="closeForm" icon="el-icon-close">stop</el-button>
            ...
            <el-button v-if="status==='collecting'||status==='closed'" type="primary" @click="gotoAnalysis"
                       icon="el-icon-s-data">analyse
            </el-button>
            <el-button v-if="status==='editing'" type="primary" @click="gotoEdit" icon="el-icon-edit">Editor</el-button>
